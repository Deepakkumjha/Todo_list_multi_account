...
INSTALLED_APPS = [
    ...
    "django.contrib.messages", "django.contrib.staticfiles", "corsheaders", "rest_framework", "todos",
]
MIDDLEWARE = [
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": ("todos.authentication.Auth0JWTAuthentication",),
